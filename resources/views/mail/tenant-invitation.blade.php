<x-mail::message>
    ...
    - {{ __('filament-member::default.mail.invite_invited_by') }}: **{{ $inviterName }}**
    - {{ __('filament-member::default.mail.invite_organization') }}: **{{ $tenantName }}**
    - {{ __('filament-member::default.mail.invite_role') }}: **{{ $role }}**
    ...
    {{ __('filament-member::default.message.regards') }},<br>
    {{ config('app.name') }}
</x-mail::message>
